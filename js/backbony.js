//Example app borrowed from http://arturadib.com/hello-backbonejs/
...
(function($){
  ...
  var ListView = Backbone.View.extend({
    ...
    initialize: function(){
      ...
      this.collection.bind('editing', this.listenForCustomEvents);
      this.counter = 0;
      this.render();
    },
    render: function(){
      var self = this;
      $(this.el).append('<h1>Backbone Realm</h1>');
      $(this.el).append('<p class="custom-even-listener backbone-listener"></p>');
      $(this.el).append('<button id="add">Add list item</button>');
      $(this.el).append('<ul class="backbony"></ul>');
      ...
      var wiserEvent = new CustomEvent("wiserEvent",
        {
          "detail":
          {
            ...
            "item": item.get('part1') + ' ' + item.get('part2')
          },
        bubbles: false
      });
    ...
    listenForCustomEvents: function(e){
      var notif_area = $('.backbone-listener');
      ...
      console.log("Backbone listening: ", e);
    }
  });
